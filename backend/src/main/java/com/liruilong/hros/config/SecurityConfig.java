...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        // 注意：当 Controller 抛异常时，Spring 会转发到 /error。
        // 如果 /error 未放行，前端会看到 401，而不是正确的 500 错误信息，容易误判为“接口未授权”。
        web.ignoring().antMatchers("/","/auth/code","/login","/error","/css/**","/js/**", "/index.html", "/img/**", "/fonts/**","/favicon.ico");
    }
    @Override
